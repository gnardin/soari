...
public class LIARTest {
	...
	public static void main(String[] args) {
		...
		liar.getReputationSet().setReputation("B", Facets.ERA1,
				Dimensions.COMPETENCE, RepType.DIbRp, new ReputationValue(-0.1, 1));
		
		liar.getReputationSet().setReputation("C", Facets.ERA1,
				Dimensions.COMPETENCE, RepType.DIbRp, new ReputationValue(1.0, 1));
		
		liar.getReputationSet().setReputation("D", Facets.ERA1,
				Dimensions.COMPETENCE, RepType.DIbRp, new ReputationValue(0.75, 1));
